        ...
        <div className='flex flex-col lg:flex-row'>
          ...
          <motion.div 
            ...
            <div>
              ...
              tracking-wide'>Entre em Contato</h4>
          ...
          className='flex-1 border rounded-2x1 flex flex-col gap-y-6 pb-24 p-6 items-start'>
            ...
            focus:border-accent transition-all' type='text' placeholder='Seu nome'/>
            <input className='bg-transparent border-b py-3 outline-none w-full placeholder:text-white
            focus:border-accent transition-all' type='text' placeholder='Seu email'/>
            <textarea className='bg-transparent border-b py-3 outline-none w-full placeholder:text-white
            focus:border-accent transition-all resize-none mb-12' placeholder='Sua mensagem '></textarea>
            <button className='btn btn-lg'>Mandar mensagem</button>
          </motion.form>
        </div>
      </div>
    </section>
